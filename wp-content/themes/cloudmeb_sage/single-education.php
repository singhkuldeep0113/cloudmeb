<?php
    /**
     * Template Name: Education Details Template
     */
    include 'common.php';
    $image_path = get_template_directory_uri() . "/dist/images";
    while (have_posts()) : the_post();
      $categories = get_field('education_category', get_the_ID())
?>
  ...
  <div class="education_detail_menu">
    <div class="container">
      <div class="education_detail_menu__lgtitle">
        <a href="<?php echo home_url();?>/educations"><img src="<?=$image_path?>/education/icon_back.png" alt="" class="edu_detail_back"/> Education</a>
      </div>
      <?php
  ...
  <div class="education_content">
    <div class="container">
      ...
      <div class="content__author">
        by <span>Cloudmeb · 2</span> min read
      </div>
      <div class="text-center">
        <img src="<?= get_field('education_logo', get_the_ID()); ?>" class="content__img"/>
      </div>

      <p class="content__header">
        <?php echo get_field('education_description', get_the_ID()); ?>
      </p>

      <div class="content__mdtitle">
        <?php echo get_field('education_contents', get_the_ID()); ?>
      </div>
    </div>
  </div>
